...
export const MOCK_RECOMMEND_INGRE: Ingredient[] = [
  ...
  { name: '설탕', category: '조미료/양념/육수' },
  { name: '양파', category: '채소류' },
  { name: '간장', category: '조미료/양념/육수' },
  { name: '참기름', category: '조미료/양념/육수' },
  { name: '고추가루', category: '기름/향신료/가루' },
  { name: '후추', category: '조미료/양념/육수' },
  { name: '대파', category: '채소류' },
  { name: '당근', category: '채소류' },
  { name: '식용유', category: '기름/향신료/가루' },
  { name: '계란', category: '계란/유제품' },
  { name: '고추장', category: '조미료/양념/육수' },
  { name: '올리고당', category: '조미료/양념/육수' },
...
export const MOCK_ADD_INGRE: Ingredient[] = [
